...
~/Programming/Ourobrowser/Planning/node_0_1_research/node_0_5_mock_pipeline_test/CORE_0_5_mock_pipeline_test.md; the definition and `designation` are the owner's to
write.)*
