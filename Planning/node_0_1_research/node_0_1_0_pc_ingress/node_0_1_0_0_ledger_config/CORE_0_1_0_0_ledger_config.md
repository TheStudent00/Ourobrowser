...
~/Programming/PUBLIC/Ourobrowser/Planning/node_0_1_research/node_0_1_0_pc_ingress/CORE_0_1_0_pc_ingress.md; the definition and `designation` are the owner's to
write.)*

## settled

- **Implementation:** Created `Research/pc_ingress/pc_ledger_v8_sever.yaml` defining strict V8 dead-ends for the PseudoCoup ingress parser.
