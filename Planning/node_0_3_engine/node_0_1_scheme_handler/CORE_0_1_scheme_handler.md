...
definition to sit under. The node's `designation` is still the owner's.)*

## design

*(added 2026-09-03 by the task-77 implementer. Provenance: log_183
task 77, which quotes the owner's own request —* "the browser allows python
