...
def losses(before, after):
    ...
    EXCUSED_LOSSES = {"isolate", "global_proxy", "global_template", "GetFrame", "DomWindow", "nullptr", "DeserializeInternalFieldsCallback", "world", "include", "frame", "GetMicrotaskQueue", "delete", "explicit"}
